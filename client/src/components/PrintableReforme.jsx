...
const PrintableReforme = forwardRef(({ data }, ref) => {
  return (
    <div ref={ref} style={{ width: "100%", padding: "20px" }}>
      ...
      <div style={{ marginTop: "50px", marginBottom: "20px" }}>
        <h3 style={{ textAlign: "center" }}>
          BON DU REFORME <br /> DU MATERIEL INFORMATIQUE
        </h3>
      </div>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse" }}>
        ...
        <thead>
          ...
          <tr style={{ background: "#f1f1f1" }}>
            ...
            <th style={{ border: "1px solid #ddd", padding: "8px" }}>Etat</th>
          </tr>
        </thead>
        {/* Table body */}
        <tbody>
          ...
          <tr>
            ...
            <td style={{ border: "1px solid #ddd", padding: "8px" }}>
              {moment(data.dateaquisition).format("YYYY-MM-DD")}
            </td>
            <td style={{ border: "1px solid #ddd", padding: "8px" }}>
              {moment(data.datereforme).format("YYYY-MM-DD")}
            </td>
            <td style={{ border: "1px solid #ddd", padding: "8px" }}>
              {data.etat}
            </td>
...
export default PrintableReforme;
